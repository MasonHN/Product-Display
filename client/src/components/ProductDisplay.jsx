...
class ProductDisplay extends React.Component {
  ...
  productChange() {
    Axios.get(`http://localhost:3003/products${this.state.uuid}`, {
      ...
      .then(() => {
        this.productInfo.current.children[0].children[5].style.maxHeight =
          this.productInfo.current.children[0].children[5].scrollHeight + "px";
      });
  }
  ...
  fullscreen(e) {
    if (
      e.target.className !== "fullscreenImg active" &&
      e.target.className !== "fullscreenButton--prev" &&
      e.target.className !== "fullscreenButton--next"
    ) {
    ...
    return (
      <div>
        <div className="fullscreenGallery" ref={this.fullscreenGalleryComp}>
          <FullScreenGallery
            childRef={el => (this.fullscreenChildRef = el)}
            slide={this.state.slide}
            fullscreenMoveSlide={this.fullscreenMoveSlide}
            fullscreenPrev={this.fullscreenPrev}
            fullscreenNext={this.fullscreenNext}
        ...
        <div className="mainComponentWrapper" ref={this.mainComponentWrapper}>
          ...
          <div className="sideGallery">
            <SideGallery
              ...
              slider={this.state.nav1}
              images={this.state.images}
              slideSet={this.fullscreenSlideSet}
            />
          </div>
          <br />
          <div ref={this.productInfo} className="productInformation">
            <ProductInformation
              detailButton={this.detailButtonHandler}
              infoButton={this.infoButtonHandler}
